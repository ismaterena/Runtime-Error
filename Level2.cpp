...
#define NUM_PROPS 3
	...
	void drawInterlude() {
		...
		else if (interludeStep == 4) { activeChar = 2; strcpy(name, "Samiha"); strcpy(line1, "It's a Doppelgänger. A physical manifestation of a"); strcpy(line2, "runtime error. It's mirroring our exact coordinates."); }
